...
'Download button  click' : function(client) {
    client
      .click('a[href="/"]')
      .pause(1000)
      .click('a[href="https://github.com/nightwatchjs/nightwatch/archive/v0.9.9.zip"]');
...
'click NightCloud.io' : function(client) {
  var host = 'http://nightwatchjs.org';
      client
      .url(host)
       .waitForElementVisible('body', 1000)
        .execute(function(newWindow){
                window.open('http://nightcloud.io', null, "height=1024,width=768");
                pause(10000);
            }, [host])
